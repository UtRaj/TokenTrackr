  ...
  return (
    <>
      {!completed ? (
        ...
        <>
        <div className="bg-gradient-to-r from-indigo-900 to-violet-600 flex bg-opacity-10 backdrop-blur-md">
        <Header />
        </div>
          <div className="py-4 px-4 bg-gradient-to-r from-indigo-900 to-violet-600 bg-opacity-60 backdrop-blur-md">
